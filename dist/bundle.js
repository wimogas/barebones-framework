...
$(function () {
  const $slTestLink = $(".sl-test");
  $slTestLink.on("click", e => {
    e.preventDefault();
    console.log("Hello from Sales Layer Framework");
  });
});
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".sl-test {\n  padding: 8px 16px;\n  background-color: #3bc693;\n  color: white;\n  border: none;\n  border-radius: 50%;\n}", "",{"version":3,"sources":["webpack://./src/scss/styles.scss"],"names":[],"mappings":"AAEA;EACI,iBAAA;EACA,yBAJqB;EAKrB,YAAA;EACA,YAAA;EACA,kBAAA;AADJ","sourcesContent":["$sl-v-bg_color--primary: #3bc693;\r\n\r\n.sl-test {\r\n    padding: 8px 16px;\r\n    background-color: $sl-v-bg_color--primary;\r\n    color: white;\r\n    border: none;\r\n    border-radius: 50%;\r\n}"],"sourceRoot":""}]);
// Exports
